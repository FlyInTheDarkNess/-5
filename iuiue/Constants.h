...
//用户钥匙串名称
#define KEYCHAIN_USERNAMEPASSWORD @"com.company.muniao.usernamepassword"

//uid存储名称
#define KEYCHAIN_UID @"com.company.muniao.username"

//zend存储名称
#define KEYCHAIN_ZEND @"com.company.muniao.password"

//房东店铺名称
#define KEYCHAIN_OWNERNAME @"com.company.muniao.name"

//房东聊天UUid
#define KEYCHAIN_UUID @"com.company.muniao.uuid"

//房东聊天Uzend
#define KEYCHAIN_UZEND @"com.company.muniao.uzend"

//推送Device Token
#define KEYCHAIN_DEVICE_TOKEN @"com.company.muniao.token"

//获取房东聊天UUid
#define MY_UUID ((NSString *)[iuiueCHKeychain load:KEYCHAIN_UUID])

//获取房东聊天Uzend
#define MY_UZEND ((NSString *)[iuiueCHKeychain load:KEYCHAIN_UZEND])

//获取房东聊天Device Token
#define MY_TOKEN ((NSString *)[iuiueCHKeychain load:KEYCHAIN_DEVICE_TOKEN])

//钥匙串中存储的dic
#define KEYCHAIN_DICTIONARY ((NSMutableDictionary *)[iuiueCHKeychain load:KEYCHAIN_USERNAMEPASSWORD])

//获取uid
#define MY_UID ((NSString *)[KEYCHAIN_DICTIONARY objectForKey:KEYCHAIN_UID])

//获取zend
#define MY_ZEND ((NSString *)[KEYCHAIN_DICTIONARY objectForKey:KEYCHAIN_ZEND])

//获取房东店铺名称
#define MY_OWNERNAME ([KEYCHAIN_DICTIONARY objectForKey:KEYCHAIN_OWNERNAME])
